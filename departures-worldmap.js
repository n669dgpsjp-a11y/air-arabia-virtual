window.mapSvg=function(f){
  ...
  return `<svg viewBox="0 0 360 155" role="img" aria-label="Geographical route map from ${esc(o[1])} to ${esc(d[1])}">
    ...
    <defs><clipPath id="worldClip"><rect x="0" y="0" width="360" height="151"/></clipPath></defs>
    <g clip-path="url(#worldClip)">
      <image href="https://commons.wikimedia.org/wiki/Special:FilePath/BlankMap-Equirectangular.svg" x="0" y="0" width="360" height="180" preserveAspectRatio="none" opacity="0.58" style="filter:sepia(1) saturate(.55) brightness(1.22) contrast(.9)"/>
    </g>
