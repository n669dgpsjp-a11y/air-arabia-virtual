window.mapSvg=function(f){
  ...
  if(!o||!d)return `<svg viewBox="0 0 360 180" role="img" aria-label="Map unavailable for ${esc(code(f.origin))} to ${esc(code(f.destination))}"><rect width="360" height="180" fill="#d9f1f4"/><text x="180" y="92" text-anchor="middle" class="map-airport-label">Map unavailable for this airport code</text></svg>`;
  ...
  return `<svg viewBox="0 0 360 180" role="img" aria-label="Geographical route map from ${esc(o[1])} to ${esc(d[1])}">
    <rect width="360" height="180" fill="#d9f1f4"/>
    <image href="https://commons.wikimedia.org/wiki/Special:FilePath/BlankMap-Equirectangular.svg" x="0" y="0" width="360" height="180" preserveAspectRatio="none" opacity="0.42"/>
